...
Download The Excel File
    Add heading    Please enter the Excel URL
    Add text input    name=excel
    ${URL}=    Run dialog
    Download    ${URL.excel}    overwrite=True

*** Keywords ***
Get Orders
    Wait Until Keyword Succeeds    ${GLOBAL_RETRY_AMOUNT}  ${GLOBAL_RETRY_INTERVAL}    Download The Excel File
